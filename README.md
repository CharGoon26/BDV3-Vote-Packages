...
* Just fill in the other slots you need to fill in, then save it
...
* Click update webhook, then copy webhook auth key and paste it in discordlist configuration in admin panel. Save it
  <img width="1271" height="917" alt="image" src="https://github.com/user-attachments/assets/5c2b69d5-0b3e-4151-a950-c2162c97bb9f" />
